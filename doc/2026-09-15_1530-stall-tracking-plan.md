...
| 1    | W1-E webapp    | webapp repo: `src/composables/useProxyAPI.ts`, `src/services/stallReporter.ts` (+ spec), `src/composables/useSSEClient.ts`, the page_request sender/consumer, `docs/`                                                                                         | done (gate green, advisor running)                                                        |
...
| gate | fable-review   | advisor pass on the combined diff                                                                                                                                                                                                                             | backend: REWORK → F1 ingest caps, F2/F3/F4 tests, F5/F6 fixed, F7/F8 docs; re-gated green |
