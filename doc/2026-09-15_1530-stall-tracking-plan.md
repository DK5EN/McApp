...
| ship | dev-release    | both repos, deploy to mcapp.local, verify `/api/stalls` live and one client record landing                                                                                                                                                                    | done: v2.0.8-dev.3 on slot-0, epoch 4 (Caddy drop-in follow-up bcc51a7); reboot of mcapp.local still pending for the boot config; client half not yet seen from a real browser |
